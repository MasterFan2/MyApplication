package com.jsbn.mgr.widget.datepicker.bizs.decors;
...
//        canvas.drawCircle(rect.centerX(), rect.centerY(), 2, paint);
    }
    ...
    public void drawDecorBG(Canvas canvas, Rect rect, Paint paint) {
        //canvas.drawText("今天", rect.centerX(), rect.centerY(), paint);
    }
}
