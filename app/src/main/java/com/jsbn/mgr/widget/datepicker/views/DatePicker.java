...
import com.jsbn.mgr.widget.datepicker.utils.MeasureUtil;
...
public class DatePicker extends LinearLayout {
     ...
     * refresh click
     */
    public OnClickListener onRefreshClickListener ;
    public OnClickListener getOnRefreshClickListener() {
        return onRefreshClickListener;
    }
    ...
    public DatePicker(Context context, AttributeSet attrs) {
        ...
        tvEnsure.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != onRefreshClickListener) {
    ...
    public void setOnMonthChange(OnMonthChange m){
    ...
    public void selfChecked(String date){
        monthView.selfChecked(date);
    }

    public void selfUnChecked(String date){
        monthView.selfUnChecked(date);
    }

    public void jsbnUsedCheck(String date){
        monthView.jsbnUsedCheck(date);
    }

    public void jsbnUsedUncheck(String date){
        monthView.jsbnUsedUnChecked(date);
    }

    public void jsbnOrderCheck(String date){
        monthView.jsbnOrderCheck(date);
    }

    public void jsbnOrderUncheck(String date){
        monthView.jsbnOrderUnChecked(date);
    }
    ...
    public void setOnDaySelected(MonthView.OnDaySelected onDaySelected){
        monthView.setOnDaySelected(onDaySelected);
    }
